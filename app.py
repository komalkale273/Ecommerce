...
def login():
    ...
    if request.method == 'POST' and form.validate():
        ...
        password_candidate = form.password.data  # Plain text password
        ...
        if result > 0:
            ...
            data = cur.fetchone()
            stored_password = data['password']  # Plain text password from DB
            uid = data['id']
            name = data['name']
...
def register():
    ...
    if request.method == 'POST' and form.validate():
        ...
        username = form.username.data
        password = form.password.data  # Store plain text password
...
def admin_login():
    if request.method == 'POST':
        ...
        password_candidate = request.form['password']  # Plain text password
